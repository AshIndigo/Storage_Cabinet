...
//
//public class CabinetManagerScreen extends BaseHandledScreen<CabinetManagerDescription> {
//
//    public CabinetManagerScreen(CabinetManagerDescription linkedContainer, PlayerInventory playerInv, Text name) {
...
//        tab.getBody().setLabel(cabinetEntity.getDisplayName());
