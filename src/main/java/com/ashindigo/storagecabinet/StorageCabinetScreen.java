...
public class StorageCabinetScreen extends BaseContainerScreen<StorageCabinetContainer> {
    ...
    public StorageCabinetScreen(Text name, StorageCabinetContainer linkedContainer, PlayerEntity player, int x, int y, int m) {
        ...
        WVerticalScrollableContainer panel = mainInterface.createChild(WVerticalScrollableContainer.class, Position.of(mainPanel).setZ(1).setOffsetY(18), Size.of((9 * 18) + 18, 162));
        WSlot.addPlayerInventory(Position.of(mainPanel).setZ(1).setOffsetY(162 + 27).setOffsetX(6), Size.of(18, 18), mainPanel);
